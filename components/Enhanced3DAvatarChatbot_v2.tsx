...
import { Send, Mic, MicOff, Volume2, VolumeX, RotateCcw, Pause, Play } from 'lucide-react'
...
export function Enhanced3DAvatarChatbot() {
  ...
  const breatheIntervalRef = useRef<NodeJS.Timeout>()
  ...
  const applyEmotion = useCallback((emotion: 'neutral' | 'happy' | 'surprised' | 'confused') => {
    ...
    const emotionMorphs: Record<string, Partial<BlendShapeTargets>> = {
      neutral: { mouthSmile: 0.0, eyeWideLeft: 0.0, eyeWideRight: 0.0, browDownLeft: 0.0, browDownRight: 0.0 },
      happy: { mouthSmile: 0.7, eyeSquintLeft: 0.3, eyeSquintRight: 0.3 },
      surprised: { eyeWideLeft: 0.8, eyeWideRight: 0.8, jawOpen: 0.3, browInnerUp: 0.6 },
      confused: { browDownLeft: 0.4, browDownRight: 0.4, mouthFrownLeft: 0.3, mouthFrownRight: 0.3 }
    }
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Button
              ...
              className={`${isMuted ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-600'}`}
            >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-1/2 bg-gradient-to-b from-gray-900 to-gray-700 relative overflow-hidden">
          <div className="absolute inset-0">
            <SimpleAvatarViewer
              ref={avatarRef}
              avatarUrl="https://models.readyplayer.me/67693d7c01da9c30e4ed2b30.glb"
          ...
          <div className="border-t border-gray-200 p-4 bg-gray-50">
            <div className="flex space-x-3">
              <Textarea
                ...
                className="flex-1 resize-none border-2 border-gray-200 rounded-xl focus:border-blue-400 focus:ring-0 bg-white"
                rows={2}
                onKeyPress={(e) => {
              ...
              <Button
                ...
                className="bg-blue-500 hover:bg-blue-600 text-white rounded-xl px-6 self-end transition-all duration-200 transform hover:scale-105"
              >
                {isLoading ? (
