interface ParentMenuTabProps {
  onBackToChild: () => void
}

export default function ParentMenuTab({ onBackToChild }: ParentMenuTabProps) {
  return (
    <div className="space-y-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-700 mb-2">PARENT CONTROLS</h1>
